...
RUN usermod -u 10001 nginx \
    && groupmod -g 60000 nginx
RUN chown -R 10001:60000 /var/cache/nginx /var/run /var/log/nginx /var/cache/nginx/ /var/lib/nginx/ /run/nginx/ /etc/nginx/ /var/lib/nginx/data/
